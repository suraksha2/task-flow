...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Add JWT-based authentication with refresh tokens', required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: enums_1.TaskStatus, required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(enums_1.TaskStatus),
    __metadata("design:type", String)
], CreateTaskDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: enums_1.TaskPriority, required: false }),
    (0, class_validator_1.IsOptional)(),
